...
import name.neday.apple.daydayrun.adapter.NearPeopleAdapter;
...
public class NearPeopleActivity extends ActivityBase implements IXListViewListener,OnItemClickListener {
	...
	private double QUERY_KILOMETERS = 10000;//默认查询1公里范围内的人
	@Override
	...
	private void initNearByList(final boolean isUpdate){
		...
		if(!mApplication.getLatitude().equals("")&&!mApplication.getLongtitude().equals("")){
			...
			userManager.queryKiloMetersListByPage(isUpdate,0,"location", longtitude, latitude, true,QUERY_KILOMETERS,null,true,new FindListener<User>() {
