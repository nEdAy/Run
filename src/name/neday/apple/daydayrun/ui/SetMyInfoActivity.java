...
import name.neday.apple.daydayrun.util.PhotoUtil;
...
public class SetMyInfoActivity extends ActivityBase implements OnClickListener {
	...
	Button btn_chat, btn_back, btn_add_friend,btn_location;
	...
	public void onClick(View v) {
		...
		case R.id.btn_location:
			Intent intent2 = new Intent(this, LocationSourceActivity.class);
	...
	private void showAvatarPop() {
		...
		avatorPop.setWidth(LayoutParams.MATCH_PARENT);
		avatorPop.setHeight(LayoutParams.WRAP_CONTENT);
