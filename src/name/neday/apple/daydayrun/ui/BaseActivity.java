...
import name.neday.apple.daydayrun.view.HeaderLayout.HeaderStyle;
import name.neday.apple.daydayrun.view.HeaderLayout.onLeftImageButtonClickListener;
...
public class BaseActivity extends FragmentActivity {
	...
	public void initTopBarForBoth(String titleName, int rightDrawableId,String text,
		...
		mHeaderLayout.setTitleAndLeftImageButton(titleName,
				R.drawable.base_action_bar_back_bg_n,
