...
import name.neday.apple.daydayrun.location.UserLocation;
import name.neday.apple.daydayrun.util.CollectionUtils;
import name.neday.apple.daydayrun.util.SharePreferenceUtil;
...
public class CustomApplcation extends Application {
	...
	public class MyLocationListener implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			if(BmobUserManager.getInstance(null).getCurrentUserName() != null){
				String username = BmobUserManager.getInstance(null).getCurrentUserName();
				userlocation.setUsername(username);
			}
			else{
				userlocation.setUsername("null");
			}

			userlocation.setLocation(locationstr);
			userlocation.setCoordinate(coordinate);
			userlocation.setRadius(location.getRadius());
			userlocation.save(getBaseContext(), new SaveListener() {
				@Override
