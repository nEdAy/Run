package name.neday.apple.daydayrun.electric;
...
public class CustomPaint {
	...
	public Paint mLighnitngColorPaint = new Paint();// 缁嗙嚎
	public Paint mLighnitngColorPaintBold = new Paint();// 绐勯槾锟?
	public Paint mLighnitngGlowPaint = new Paint();// 绮楃嚎
	public Paint mLighnitngGlowPaintBold = new Paint();// 瀹介槾锟?
